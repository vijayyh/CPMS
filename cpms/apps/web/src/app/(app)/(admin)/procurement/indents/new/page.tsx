      ...
      <section className="flex flex-col md:flex-row md:items-end justify-between" style={{ gap: '24px' }}>
        <div className="flex flex-col" style={{ gap: '8px' }}>
          <div className="flex items-center" style={{ gap: '12px' }}>
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-[var(--text-title)]">Create New Indent</h1>
          </div>
          <p className="text-base text-muted font-medium" style={{ marginLeft: '36px' }}>Request materials for a specific project site.</p>
        </div>
      </section>
        ...
        <div className="glass-panel rounded-[var(--radius-xl)] border border-[var(--bg-border-solid)] flex flex-col col-span-1 lg:col-span-12 overflow-hidden shadow-float-sm bg-[var(--bg-card)]">
          <div className="flex justify-between items-center border-b border-[var(--bg-border-solid)] bg-[var(--bg-card-solid)] shrink-0" style={{ padding: '20px 24px' }}>
            <div className="flex items-center" style={{ gap: '12px' }}>
              ...
              <h3 className="text-base font-bold tracking-tight text-[var(--text-title)] truncate">Indent Details</h3>
            </div>
            <span className="badge badge-info text-xs font-bold whitespace-nowrap shrink-0 shadow-sm tracking-wide" style={{ padding: '6px 12px' }}>DRAFT</span>
          </div>
          ...
          <div className="flex-1 flex flex-col" style={{ padding: '32px 24px', gap: '32px' }}>
            <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: '24px' }}>
              ...
              <div className="flex flex-col" style={{ gap: '8px' }}>
                <label className="text-sm font-bold text-[var(--text-title)]">Required Date</label>
            ...
            <div className="flex flex-col" style={{ gap: '8px' }}>
              <label className="text-sm font-bold text-[var(--text-title)]">Materials List</label>
              <div className="border border-dashed border-[var(--bg-border-solid)] rounded-xl flex flex-col items-center justify-center text-center p-8 bg-[var(--bg-hover)]">
                <span className="text-muted font-medium text-sm">Click here to add items to your indent</span>
              </div>
            </div>
