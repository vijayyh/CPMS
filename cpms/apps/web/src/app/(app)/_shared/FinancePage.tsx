...
export default async function FinanceDashboardPage({ dashboardPath = "/dashboard" }: { dashboardPath?: string }) {
  ...
  return <FinanceClient projects={processedProjects} vendors={processedVendors} dashboardPath={dashboardPath} />;
}
